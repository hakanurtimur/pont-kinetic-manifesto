...
export const REVENUE_ENGINES = Object.freeze([
  ...
  Object.freeze({ name: 'ACADEMY', detail: 'AI-NATIVE EDUCATION · EXECUTIVE PROGRAMMES · FUTURE ACADEMY' }),
]);
...
export const SCENES = Object.freeze([
  ...
  },
  {
    ...
    argument: 'PONT IS BEING DEVELOPED NEXT TO THE STACK, IN AMSTERDAM OOST, WITH ROOM TO GROW TOWARDS APPROXIMATELY 10.000 M².',
    layers: HOME_LAYERS,
  },
  {
    id: 'stack-pont',
  ...
  },
  {
    ...
    argument: 'PONT INTENDS TO ESTABLISH A FOUNDER-FIRST ACADEMY, DESIGNED FROM THE GROUND UP AROUND ENTREPRENEURSHIP, TECHNOLOGY, PROJECTS, COMPETENCIES, NETWORKS AND REAL-WORLD PRODUCTION.',
    layers: UNIVERSITY_LAYERS,
  },
  {
    id: 'university-inside-companies',
    index: '17',
    eyebrow: 'THE FOUNDER-FIRST ACADEMY',
    statements: [
